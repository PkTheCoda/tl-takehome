    ...
    <div className="bg-white w-full shadow-2xl flex flex-col">
      <div className="flex items-center justify-between px-8 pt-8 pb-4">
        <select className="border border-gray-300 rounded-md px-4 py-2 text-sm bg-white">
          <option>{formatVersionLabel(form.updated_at)}</option>
        </select>
      ...
      <form className="px-8 py-8 flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <select
            ...
            className="w-full border border-gray-300 rounded-md px-4 py-2.5 bg-white"
          >
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            rows={5}
            className="w-full border border-gray-300 rounded-md px-4 py-2.5 resize-y"
          />
